...
const DATA = {
  ...
  Parker: {
    ring:2, dates:"1885–1949", title:"The Michigan Parallel", confirmed:true,
    desc:"Parker was at Harvard 1906–08, trained in exactly the years of ELC's most active Harvard presence, then chaired the Michigan philosophy department from 1929 succeeding the Caird-trained Wenley. His Self and Nature (1917), Human Values (1931), and Experience and Substance (1941) constitute a systematic conditions account of value theory developed in parallel to ELC's practical ethics. His 1945 article 'Esse Est Percipi' in the Journal of Philosophy engaged Moore's foundational argument directly from within the Michigan idealist tradition. He published in a 1932 International Journal of Ethics symposium on ethics education alongside figures in ELC's network. Hoernlé co-authored a paper with him in the Philosophical Review in 1934.",
    elc:"Parker and ELC were trained by the same tradition in overlapping years — both at Harvard in the first decade of the century, both systematising practical value theory in the 1930s, apparently without awareness of each other's parallel work. Both were doing the Michigan-Boston idealist practical ethics in the same journals simultaneously. His Michigan position as successor to the Caird-trained Wenley places him in the direct institutional chain from Caird through the American Midwest. His Philosophical Review paper with Hoernlé documents his active engagement with the same scholarly networks connecting to ELC's tradition.",
    inf:[["T.H. Green","Self-realisation ethics; conditions for genuine value; Harvard formation"],["Harvard idealist tradition","Palmer-Royce formation 1906-08"],["Wenley","Michigan predecessor; Caird student; direct institutional chain"],["Hoernlé","Co-authored Philosophical Review 1934; synoptic idealism parallel"]],
    out:[["Michigan idealist tradition","Department chair 1929; continuation of Caird-Wenley chain"],["ELC","Parallel project — value theory conditions account simultaneously developed"],["International Journal of Ethics","1932 ethics education symposium alongside ELC network figures"]],
    works:[["The Self and Nature (1917)","University of Michigan Press — conditions for genuine selfhood"],["Human Values (1931)","University of Michigan Press — systematic value theory"],["Experience and Substance (1941)","University of Michigan Press — metaphysics of experience"],["'Esse Est Percipi' (1945)","Journal of Philosophy — engages Moore from within Michigan idealism"]],
    archives:[["Bentley Historical Library, University of Michigan","DeWitt H. Parker Papers — primary archive. Correspondence with Hoernlé (Philosophical Review collaboration) is the priority target."]]
  },
  "De Laguna": {
    ring:3, dates:"1878–1978", title:"The Cornell Bridge to Phenomenology", confirmed:true,
    desc:"Grace Andrus de Laguna is the single most philosophically significant of the Cornell women in the network — she lived to 100, her career spanning the entire tradition from its formation to its aftermath. Cornell PhD under Creighton, then Bryn Mawr for her entire career. She studied under Heidegger in Freiburg in 1931 — the personal American bridge between the Cornell idealist tradition and German phenomenology, one decade after Hocking had bridged American idealism and Husserl. Her Speech: Its Function and Development (1927) is a pioneering work in philosophy of language arguing that speech is fundamentally a social act before it is a cognitive one — the social engagement condition stated from within philosophy of language. She criticised Heidegger's account of being-in-the-world in a 1939 Mind paper, arguing it failed to account for genuine social constitution of the self — exactly the Pringle-Pattison objection applied to existentialism. On Existence and the Human Good (1966) is her most comprehensive philosophical statement.",
    elc:"De Laguna belongs in Ring III because her starting point is philosophy of language and phenomenology rather than experience as found. But her criticism of Heidegger — that his account of Dasein fails to specify what genuine social constitution requires — is precisely the move ELC's social engagement condition makes against every account that treats social engagement as secondary to individual existence. Her Speech argument — that language is constitutively social before it is cognitive — is the philosophy of language parallel to ELC's social engagement condition. She is in the tradition via Cornell rather than Harvard-Radcliffe, which makes her the most important Cornell woman for the philosophical web.",
    inf:[["Creighton","Cornell idealist formation; Philosophical Review milieu"],["Heidegger","Freiburg 1931; direct study; then criticised his account of social constitution"],["Husserl","Phenomenological method filtered through Heidegger"],["Cornell idealist tradition","Schurman-Creighton formation; American idealism"]],
    out:[["Philosophy of language","Speech: Its Function and Development as foundational social-act theory"],["Bryn Mawr tradition","Decades of influence on students"],["ELC","Parallel social constitution argument — Ring III because different starting point"]],
    works:[["Dogmatism and Evolution (1910)","Macmillan — early work; Cornell idealist formation"],["Speech: Its Function and Development (1927)","Yale University Press — language as constitutively social; primary work"],["'Existence and Character in Heidegger's Philosophy' (1939)","Mind — criticism of Heidegger on social constitution; directly relevant"],["On Existence and the Human Good (1966)","Yale University Press — comprehensive philosophical statement"]],
    archives:[["Bryn Mawr College Special Collections","Grace Andrus de Laguna Papers — primary archive. Correspondence with Cornell and Bryn Mawr networks. Long career 1907–1966 means extensive materials."]]
  },
  Perry: {
    ring:4, dates:"1876–1957", title:"The Institutional Displacer", confirmed:true,
    desc:"Perry belongs in Ring IV not because his philosophy is without merit — his General Theory of Value (1926) is a serious contribution to value theory — but because his institutional role was the direct displacement of the Palmer-Royce tradition at Harvard. He was James's student and biographer (The Thought and Character of William James, 1935, two volumes, Pulitzer Prize), but he deployed New Realism as the analytic replacement for the idealist tradition he had been trained within. His New Realism (1912, co-authored manifesto with five others) argued that objects of consciousness are independent of consciousness — the direct inversion of the idealist starting point. His Puritanism and Democracy (1944) shows his practical ethics register. His most consequential act for ELC's invisibility: as the keeper of the James legacy and the Harvard philosophy department's direction through the first half of the twentieth century, he shaped what counted as philosophically serious in the tradition that had produced ELC — and the Green-Palmer-Cabot practical ethics tradition did not count.",
    elc:"Perry's dismissal of the Palmer-Royce tradition as pre-scientific is the institutional act that made ELC invisible. He was not targeting ELC specifically — her work was already in the practical ethics register he considered below philosophical notice. But his role as James's authoritative biographer and New Realism's institutional champion at Harvard meant that the tradition's vocabulary, concerns, and methods were officially superseded. His Pulitzer-winning James biography shaped what James meant for a generation — radically empiricist James rather than pragmatist James, but not in a way that recovered ELC's fifth condition. He confirmed the pragmatist James as the important one and treated the idealist network as merely a biographical context.",
    inf:[["James","Direct student; biographer; Thought and Character of William James (1935)"],["Moore/Russell","New Realism as analytic displacement of idealism"],["Holt/Montague/Marvin/Pitkin/Spaulding","Co-authors of New Realism manifesto 1912"],["Harvard department","Institutional power to shape what counted as philosophy"]],
    out:[["New Realism","Co-authored manifesto 1912; analytic displacement of idealism"],["James biography","Shaped James reception for a generation; Pulitzer 1935"],["ELC","His institutional displacement made her invisible without targeting her directly"]],
    works:[["The New Realism (1912)","Macmillan — manifesto co-authored with five others; displacement of idealism"],["General Theory of Value (1926)","Longmans Green — systematic value theory from realist starting point"],["The Thought and Character of William James, 2 vols. (1935)","Little Brown — Pulitzer Prize; shaped James reception"],["Puritanism and Democracy (1944)","Vanguard — practical ethics in Perry's register"]],
    archives:[["Houghton Library, Harvard University","Ralph Barton Perry Papers — extensive Harvard department correspondence. Documents the institutional displacement of the Palmer-Royce tradition."]]
  },
  Schiller: {
    ring:4, dates:"1864–1937", title:"The Humanist Displacer", confirmed:true,
    desc:"Ferdinand Canning Scott Schiller is Oxford's pragmatist — the British parallel to Perry's institutional displacement of idealism, operating through philosophical humanism rather than New Realism. His Humanism: Philosophical Essays (1903) and Studies in Humanism (1907) argued that truth is made by human beings rather than discovered — a stronger subjectivist reading of pragmatism than James held. He was the primary British force making pragmatism the alternative to idealism, which meant the Green-Caird tradition was displaced at Oxford precisely when it was also being displaced at Harvard by different means. His reviews were widely read in the journals where the practical ethics tradition published — he reviewed Flewelling in the Hibbert Journal, placing him in documented contact with the American Personalist tradition simultaneously. His Students' Oxford Dictionary (1932) shows his popular register. His humanism is the cultural displacement that accompanied the philosophical displacement: making idealism look like Victorian pieties rather than serious philosophy.",
    elc:"Schiller reviewed books in the same journals where the ELC-adjacent tradition published — he was part of the review network that shaped what was taken seriously. His Oxford position and his influence on British popular philosophy meant that the practical ethics register ELC worked in was culturally associated with the idealism he was displacing. He did not target ELC specifically; he targeted the tradition's credibility. His friendship with James while pushing pragmatism further toward subjectivism than James wanted shows the pressure James was under from both sides — Schiller pushing toward humanism, Royce holding the Absolute.",
    inf:[["James","Pragmatist method; personal friendship; pushed further than James wanted"],["Oxford empiricist tradition","Formation against which he reacted toward pragmatism"],["Protagoras","Humanism as ancient pedigree; man as measure of all things"]],
    out:[["British pragmatism","Primary advocate at Oxford"],["ELC","Cultural displacement of the tradition's credibility"],["Perry","Parallel institutional displacement from different direction"]],
    works:[["Riddles of the Sphinx (1891, as 'A Troglodyte')","Swan Sonnenschein — early pragmatist statement"],["Humanism: Philosophical Essays (1903)","Macmillan — founding humanist statement; truth as made not discovered"],["Studies in Humanism (1907)","Macmillan — extended humanist philosophy"],["Formal Logic: A Scientific and Social Problem (1912)","Macmillan"],["Must Philosophers Disagree? (1934)","Macmillan — late essays"]],
    archives:[["Bodleian Library, Oxford","F.C.S. Schiller Papers — correspondence with James and Oxford network."],["USC Digital Library","Schiller-James correspondence partially digitised."]]
  },
  "F. Kelley": {
    ring:5, dates:"1859–1932", title:"The Legislative Deployment", confirmed:true,
    desc:"Florence Kelley is the most consequential practical deployer of the conditions account in American legal history. She lived at Hull-House, translated Engels's Condition of the Working Class in England into English (1887), directed the National Consumers League from 1899 to 1932, and wrote Some Ethical Gains Through Legislation (1905) — the American parallel to Helen Bosanquet's social welfare writing, but from a structural provision rather than character formation perspective. The Consumers League under her leadership produced the first minimum wage law (Oregon, 1912), the first child labor laws, and the framework that became the Fair Labor Standards Act (1938). She studied at Cornell and Zurich. Her Some Ethical Gains Through Legislation specifies what structural legislation must accomplish for genuine human development to be possible — ELC's five conditions stated as a legislative agenda.",
    elc:"Kelley and ELC are parallel American deployments of the Green-Caird tradition's practical mandate — Kelley through legislation, ELC through practical ethics and teaching. Both were working in the same period (peak activity 1899–1932) in the same progressive network. Hull-House connected Kelley to Addams, who connected to Balch and Scudder, who connected directly to ELC's Wellesley and Boston network. Kelley's legislative approach and ELC's pedagogical approach address the same structural problem from different directions: what must change for genuine human development to become possible? Kelley answers through law; ELC answers through specifying the philosophical conditions. Both are downstream of the same tradition; neither was aware of the philosophical parallel.",
    inf:[["Hull-House","Lived there; Addams connection; Green-Caird practical mandate"],["Engels","Translated Condition of the Working Class 1887; structural analysis of conditions"],["Cornell/Zurich","Academic formation in political economy and law"],["Addams","Hull-House network; College Settlements Association"]],
    out:[["National Consumers League","Directed 1899-1932; minimum wage and child labor laws"],["Fair Labor Standards Act (1938)","Legislative framework Kelley built"],["ELC","Independent convergence — legislative vs pedagogical deployment of same conditions"],["Pauline Newman/Clara Lemlich","Labour organising tradition built on Consumers League framework"]],
    works:[["Some Ethical Gains Through Legislation (1905)","Macmillan — conditions for genuine human development as legislative agenda; primary text"],["Modern Industry in Relation to the Family (1914)","Longmans Green — conditions analysis applied to industrial labour"],["The Working Child (1896)","National Consumers League — child labour conditions"]],
    archives:[["Columbia University Rare Book and Manuscript Library","Florence Kelley Papers — primary archive. National Consumers League records."],["University of Illinois at Chicago, Richard J. Daley Library","Hull-House Records — Kelley's Hull-House period documented here alongside Addams."]]
  }
};
